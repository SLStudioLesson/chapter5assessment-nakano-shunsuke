    ...
    public void displayMenu() {
        ...
        while (flg) {
            try {
                ...
                switch (selectMenu) {
                    // タスク一覧機能を呼ぶ（taskLogicにアクセス）
                    // タスク一覧表示後に、ステータス更新メニューを呼ぶ
                    case "1": taskLogic.showAll(loginUser); selectSubMenu(); break;
                    // タスク新規登録機能を呼ぶ
                    case "2": inputNewInformation(); break;
                    case "3":
